...
#pickle the results
with open("bootstrap_std_9000_areaweight_modelspread", "wb") as fp:   #Pickling
    pickle.dump(std_member2, fp)
with open("bootstrap_mean_9000_areaweight_modelspread", "wb") as fp:   #Pickling
    pickle.dump(mean_member2, fp)
with open("bootstrap_change_water_9000_areaweight_modelspread","wb") as fp:
