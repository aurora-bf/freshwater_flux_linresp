...
#pickle the results
with open("bootstrap_std_3000_areaweight_lintrend_12sept", "wb") as fp:   #Pickling
    pickle.dump(std_member2, fp)
with open("bootstrap_std_including_indiv_variance_3000_areaweight_lintrend_12sept", "wb") as fp:   #Pickling
    pickle.dump(std_including_individual_variances2, fp)
with open("bootstrap_mean_3000_areaweight_lintrend_12sept", "wb") as fp:   #Pickling
    pickle.dump(mean_member2, fp)
with open("bootstrap_change_water_3000_areaweight_lintrend_12sept","wb") as fp:
    pickle.dump(change_water, fp)
with open("bootstrap_individual_variance_water_3000_areaweight_lintrend_12sept","wb") as fp:
