...
#Calculates the area of grid cells if you don't have an area mask and only have the latitudes and longitudes of the centres of the cells. The function should work in situations both with equal grid spacing globally and with variable grid spacing.
